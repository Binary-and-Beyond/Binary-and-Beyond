...
function createTextTexture(
  gl: GL,
  text: string,
  font: string = "bold 36px monospace",
  color: string = "black"
...
class Media {
  ...
  onResize({
    ...
    this.plane.scale.x =
      (this.viewport.width * targetWidth) / this.screen.width;
    this.plane.scale.y =
      (this.viewport.height * targetHeight) / this.screen.height;
